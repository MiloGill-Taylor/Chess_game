...
MAP_SQR_TO_VEC = {
	...
	"a6": Vector([2,0]), "b6": Vector([2,1]), "c6": Vector([2,2]), "d6": Vector([2,3]), "e6": Vector([2,4]), "f6": Vector([2,5]), "g6": Vector([2,6]), "h6": Vector([0,7]),
	"a5": Vector([3,0]), "b5": Vector([3,1]), "c5": Vector([3,2]), "d5": Vector([3,3]), "e5": Vector([3,4]), "f5": Vector([3,5]), "g5": Vector([3,6]), "h5": Vector([3,7]),
	"a4": Vector([4,0]), "b4": Vector([4,1]), "c4": Vector([4,2]), "d4": Vector([4,3]), "e4": Vector([4,4]), "f4": Vector([4,5]), "g4": Vector([4,6]), "h8": Vector([4,7]),
